...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setBackgroundImage:[[UIImage imageNamed:@"tokenNormal"] stretchableImageWithLeftCapWidth:13.0f topCapHeight:12.0f]
                        forState:UIControlStateNormal];
        [self setBackgroundImage:[[UIImage imageNamed:@"tokenHighlighted"] stretchableImageWithLeftCapWidth:13.0f topCapHeight:12.0f]
...
{
    SMTokenButton *btn = [[SMTokenButton alloc]
        initWithFrame:CGRectMake(0.0f, roundf((self.frame.size.height - 25.0f) / 2.0f),
                                 MIN([tokenText sizeWithAttributes:@{NSFontAttributeName:self.txtField.font}].width + 35.0f, self.frame.size.width - 15.0f), 25.0f)];
