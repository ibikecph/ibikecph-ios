...
//    }
//    return meters >= 1000.0f ? [NSString stringWithFormat:@"%.1f %@", meters/1000.0f, DISTANCE_KM_SHORT] : [NSString stringWithFormat:@"%.0f %@",
//    meters, DISTANCE_M_SHORT];
//}
//
//// Format time duration string (choose between seconds and hours)
// NSString *formatTime(float seconds) {
//    return seconds > 60.0f ? [NSString stringWithFormat:@"%.0f %@", seconds/60.0f, TIME_MINUTES_SHORT] : [NSString stringWithFormat:@"%.0f %@",
//    seconds, TIME_MINUTES_SHORT];
//}
//
//// Format time passed between two dates
// NSString *formatTimePassed(NSDate *startDate, NSDate *endDate) {
//    NSCalendar * cal = [NSCalendar currentCalendar];
//    NSDateComponents * comp = [cal components:(NSDayCalendarUnit|NSHourCalendarUnit|NSMinuteCalendarUnit|NSSecondCalendarUnit) fromDate:startDate
...
//        stringByAppendingPathComponent:@"routes"] stringByAppendingPathComponent: [NSString stringWithFormat:@"%f.%@", tmpd, ext]];
...
//        }
//    }
//    [[NSFileManager defaultManager] createDirectoryAtPath:[[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES)
//    lastObject] stringByAppendingPathComponent:@"routes"] withIntermediateDirectories:YES attributes:@{} error:nil];
//    return path;
//}
