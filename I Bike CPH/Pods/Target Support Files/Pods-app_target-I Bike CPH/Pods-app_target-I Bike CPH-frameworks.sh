...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Mapbox-iOS-SDK/Mapbox_iOS_SDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIImage-Categories/UIImage_Categories.framework"
fi
